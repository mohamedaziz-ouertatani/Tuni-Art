...
public class Delivery {
  ...
  public Delivery(int deliveryId, int orderId, LocalDate estimatedDate,
                  float deliveryFees, String destination, boolean state,
                  int agencyId) {
  ...
  public float getDeliveryFees() { return deliveryFees; }
  ...
  public String toString() {
    return "Delivery{"
        ...
        ", estimatedDate=" + estimatedDate + ", deliveryFees=" + deliveryFees +
