...
public class DeliveryDetails implements Initializable {
    ...
    @FXML
    private ComboBox<Integer> agencyIDComboBox;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        webEngine.load(getClass().getResource("/tn/esprit/gui/index.html").toExternalForm());
    ...
    public void confirmAddress(ActionEvent event) {
        ...
        try {
            ...
            alert.setContentText("The delivery fees are: " + deliveryFeesFloat + " TND\n\nDo you want to confirm the order?");
            ...
            if (result.isPresent() && result.get() == confirmButton) {
                ...
                if (rowsAffected == 1) {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/tn/esprit/ReceiveOrder.fxml"));
