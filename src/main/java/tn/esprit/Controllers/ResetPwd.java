...
public class ResetPwd implements Initializable {
  ...
  void redirectToVerif(ActionEvent event) throws SQLException, IOException {
    ...
    if (!us.doesEmailExist(emailFieldId.getText())) {
      ...
      String verificationCode =
          VerificationCodeGenerator.generateVerificationCode(u);
      ...
      alert.setContentText(
          "A verification code has been sent to the provided e-mail address.");
      alert.showAndWait();
      ...
      // Load the new FXML file
      Parent root =
          FXMLLoader.load(getClass().getResource("/Verification.fxml"));
      javafx.scene.image.Image icon = new Image(
          "file:/C:/Users/DELL/Documents/3A/Semester 2/PIDEV/Tuni Art/src/images/logo.png");
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
    ...
    Image goBack = new Image(
        "file:C:\\Users\\DELL\\Documents\\3A\\Semester 2\\PIDEV\\Tuni Art\\src\\images\\arrow-left.png");
