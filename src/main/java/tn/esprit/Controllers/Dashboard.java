...
public class Dashboard implements Initializable {
  ...
  @FXML private Text managementTextId;
  ...
  @FXML private Hyperlink inviteOnly;
  ...
  private List<VBox> createUserBox(List<User> users) {
    ...
    for (User user : users) {
      ...
      userBox.setStyle(
          "-fx-padding: 10px; -fx-spacing: 5px; -fx-background-color: #f7f8fa; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.3), 10, 0, 0, 0);");
      ...
      if (user.getStatus()) {
        ...
        status.setStyle(
            "-fx-background-color: #FC6541; -fx-background-radius: 55; -fx-text-fill: white;");
        status.setPadding(new Insets(10, 10, 10, 10));
      } else {
        status.setText("Activate");
        status.setStyle(
            "-fx-background-color: #36d664; -fx-background-radius: 55; -fx-text-fill: white;");
        status.setPadding(new Insets(10, 10, 10, 10));
      }
    ...
    for (gallery art : arts) {
      ...
      updateButton.setOnAction(event -> {
        ...
        try {
          ...
          Parent root =
              FXMLLoader.load(getClass().getResource("/Update_Gallery.fxml"));
          javafx.scene.image.Image icon =
              new Image("file:/src/images/logo.png");
      ...
      addButton.setOnAction(event -> {
        ...
        try {
          ...
          Parent root =
              FXMLLoader.load(getClass().getResource("/add_gallery.fxml"));
          javafx.scene.image.Image icon =
              new Image("file:/src/images/logo.png");
      ...
      deleteButton.setOnAction(event -> {
        ...
        try {
          as.delete(
              art.getGallery_id()); // Call the delete method with the art_ref
      ...
      if(art.getImage_path()==null) {
          ...
          artImage = new ImageView(new Image("file:src\\images\\" +
      art.getImage_path()));
      }
      artImage.setFitWidth(100);
      artImage.setFitHeight(100);
  ...
  private List<VBox> createeventBox(List<Event> events) {
    ...
    for (Event event : events) {
      ...
      eventBox.getChildren().addAll(titleLabel, categoryLabel, dateLabel,
                                    durationLabel); // display everything
