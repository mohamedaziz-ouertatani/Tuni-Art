...
INSERT INTO `art` (`art_ref`, `art_title`, `art_price`, `type`, `creation`, `description`, `style`, `artist_id`, `isAvailable`) VALUES
(1, 'Art Title', 100, 'Oil Painting', '2024-02-14', 'Description text', 'Abstract', 1, 0),
...
INSERT INTO `artist` (`aid`, `fname`, `lname`, `email`, `gender`, `phone_nb`, `profile_pic`, `birth_date`, `password`, `biography`, `portfolio`, `verification_code`) VALUES
(1, 'John', 'Artist', 'john.artist@example.com', 1, 123456789, NULL, '1990-01-01', 'password', 'Biography text', 'Portfolio text', NULL);
...
INSERT INTO `cart` (`cart_ref`, `uid`, `art_ref`) VALUES
(55, 1, 1),
(56, 1, 9),
(57, 1, 7),
(58, 1, 11),
...
INSERT INTO `delivery` (`delivery_id`, `order_id`, `estimated_date`, `delivery_fees`, `destination`, `state`, `agency_id`) VALUES
(1, 18, '2024-02-26', 20, 'Tunis', 1, 1),
...
INSERT INTO `order` (`order_id`, `uid`, `order_date`, `totalprice`, `status`) VALUES
(18, 1, '2019-02-02', 6000, 1),
...
(1, 'Arij', 'Mahouechi', 'arij.mahouechi@esprit.tn', 1, 22334455, NULL, '2001-10-12', '12131415', NULL),
...
--
ALTER TABLE `art`
  MODIFY `art_ref` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `cart`
  MODIFY `cart_ref` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT for table `delivery`
--
ALTER TABLE `delivery`
  MODIFY `delivery_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=251140;
